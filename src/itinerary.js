...
//             <span class="fs-5">${city.img_url}</span>
    ...
    <div class="weather-widget">
      <div class="weather-current">
        ...
        <div class="weather-city d-flex align-items-center gap-2 mt-2">
          <img src="${city.img_url || ''}" alt="" class="rounded shadow-sm" style="width: 24px; height: 24px; object-fit: cover;" onerror="this.style.display='none'">
          <p class="mb-0 fw-bold">${city.name}, ${city.country}</p>
        </div>
      </div>
      <div class="weather-forecast">
        ${forecasts.slice(0, 5).map(day => `
